...
int main(void)
{
  ...
  Task_key_scanHandle = osThreadNew(Task_key_scan_f, NULL, &Task_key_scan_attributes);

  /* creation of Task_NTC_scan */
  Task_NTC_scanHandle = osThreadNew(Task_NTC_scan_f, NULL, &Task_NTC_scan_attributes);

  /* creation of Task_led */
  Task_ledHandle = osThreadNew(Task_led_f, NULL, &Task_led_attributes);

  /* creation of Task_display */
  Task_displayHandle = osThreadNew(Task_display_f, NULL, &Task_display_attributes);
